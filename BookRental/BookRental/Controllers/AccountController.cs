    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register()
        {
            using (var db = ApplicationDbContext.Create())
            {
                ...
                {
                    MembershipTypes = db.MembershipTypes.Where(m => !(m.Name.ToLower().Equals(Utility.SD.AdminUserRole.ToLower()))).ToList(),
                    BDay = DateTime.Now.Date.ToString()
                };
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
                {
                    ...
                    Email = model.Email,
                    BDay = DateTime.Parse(model.BDay),
                    FName = model.FName,
                    LName= model.LName,
                    Phone = model.Phone,
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var names = info.ExternalIdentity.Name.Split(' ');
                var fName = names[0].ToString();
                var lName = names[1].ToString();
                var user = new ApplicationUser
                {
                    UserName = model.Email,
                    Email = model.Email,
